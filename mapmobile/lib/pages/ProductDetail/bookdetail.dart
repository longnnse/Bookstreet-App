                                  ...
                                  children: [
                                    ...
                                    DynamicText(
                                        text: product['book']
                                                ?['distributorName'] ??
                                            ""),
                                    const DynamicText(text: ("Ngày xuất bản")),
                                    DynamicText(
                                        text: product['book']?['publicDay'] ??
                                            "chưa có"),
                                    ...
                                    DynamicText(
                                        text: product['book']
                                            ...
                                            ? product['book']['editionNumber']
                                                .toString()
                                            : "1"),
                                    const DynamicText(text: ("Năm tái bản")),
                                    DynamicText(
                                        text: product['book']?['editionYear'] !=
                                                null
                                            ? product['book']['editionYear']
                                                .toString()
                                            : ""),
                                    const DynamicText(text: ("Isbn")),
                                    DynamicText(
                                        text: product['book']?['isbn'] != null
                                            ? product['book']['isbn'].toString()
                                            : "")
                                  ],
                                ),
                              ],
